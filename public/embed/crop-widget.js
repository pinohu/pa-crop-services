...
(function() {
  ...
  function createModal() {
    ...
    overlay.innerHTML = [
      ...
      '    <p style="font-size:11px;color:#9ca3af;margin-top:12px;text-align:center">Powered by <a href="https://pacropservices.com" target="_blank" style="color:#534AB7">PA CROP Services</a> · Erie, PA · Licensed PA CROP Provider</p>',
      '  </div>',
      ...
      '    <a href="https://pacropservices.com" target="_blank" style="display:inline-block;margin-top:16px;padding:12px 24px;background:#0f1e3d;color:#fff;text-decoration:none;border-radius:8px;font-weight:600;font-size:14px">View PA CROP Plans →</a>',
      '  </div>',
      '</div>',
    ].join('');
