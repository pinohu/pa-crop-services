...
const doc1 = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      p([b("Entity: "), n("[ENTITY NAME, e.g., PA Registered Office Services, LLC]")]),
...
const doc3 = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      new Paragraph({ spacing: { after: 80 }, numbering: { reference: "steps", level: 0 }, children: [new TextRun({ text: "Entity name: PA Registered Office Services, LLC (or your chosen name)", size: 22, font: "Arial" })] }),
